...
export const hudWeaponSlots = document.getElementById("hudWeaponSlots");
...
export const hudGrenadeCharge = document.getElementById("hudGrenadeCharge");
export const hudGrenadeChargeFill = document.getElementById("hudGrenadeChargeFill");
export const hudAmmo = document.getElementById("hudAmmo");
export const hudAmmoCount = document.getElementById("hudAmmoCount");
export const hudReloadKey = document.getElementById("hudReloadKey");
export const hudReloadStatus = document.getElementById("hudReloadStatus");
...
export const cameraSensitivityInput = document.getElementById("cameraSensitivityInput");
export const cameraSensitivityValue = document.getElementById("cameraSensitivityValue");
...
export const deathKillerWeapon = document.getElementById("deathKillerWeapon");
export const deathKillerWeaponIcon = document.getElementById("deathKillerWeaponIcon");
...
export const touchReloadBtn = document.getElementById("touchReloadBtn");
export const touchWeaponSwitchBtn = document.getElementById("touchWeaponSwitchBtn");
